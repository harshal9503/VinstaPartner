...
const OrderManagement = () => {
  ...
  const orderManagementData = [
    { label: 'Live Orders', value: '5 Orders' },
    { label: 'Past Orders', value: '120 Orders' },
    { label: 'Cancelled Orders', value: '8 Orders' },
    { label: 'Delivery Status Tracking', value: 'Enabled' },
    { label: 'Order Preparation Time', value: '25 Minutes' },
    { label: 'Assign Delivery Partner', value: 'Available' },
  ];
