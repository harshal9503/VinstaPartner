    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <View style={styles.optionContainer}>
          {settingsOptions.map(item => (
            <TouchableOpacity
              ...
              style={[
                styles.optionRow,
                { borderBottomColor: colors.tabBg },
              ]}
              activeOpacity={0.7}
            ...
            >
              <View style={styles.optionLeft}>
                <Image
                  source={item.icon}
                  style={[styles.optionIcon, { tintColor: colors.text }]}
                />
          ...
          {/* ===== LOG OUT ===== */}
          <TouchableOpacity
            style={[styles.optionRow, { borderBottomColor: colors.tabBg }]}
            activeOpacity={0.7}
            onPress={() =>
      ...
      >
        <View style={styles.popupOverlay}>
          <View
            style={[styles.popupBox, { backgroundColor: colors.cardBackground }]}
          >
